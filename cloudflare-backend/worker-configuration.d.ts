/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 70700758f75a0bad17fa678d084f746c)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DEPLOY_APP_WORKFLOW: Workflow<Parameters<import("./src/index").DeployAppWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AKASH_MANIFEST_NETWORK" | "AKASH_RELAX_UPTIME" | "CORS_ALLOWED_ORIGINS">> {}
}
